...
st.markdown("## ⚡ TECH SPECIFICATIONS")

# Progress Bars in Hazard Yellow
...
with col1:
    skill_bar("Python (Data Analysis)", 90)
    skill_bar("PHP/MySQL (Backend)", 85)
with col2:
    skill_bar("HTML/CSS (Glassmorphism)", 95)
    skill_bar("C++/Java (Logic)", 75)